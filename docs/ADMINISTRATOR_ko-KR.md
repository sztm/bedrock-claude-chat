...
LLM의 출력이 항상 사용자의 기대를 충족하지 못할 수 있습니다. 때때로 사용자의 요구를 만족시키지 못하는 경우가 있습니다. LLM을 비즈니스 운영 및 일상생활에 효과적으로 "통합"하기 위해서는 피드백 루프를 구현하는 것이 중요합니다. Bedrock Claude Chat에는 사용자가 불만족의 원인을 분석할 수 있도록 설계된 피드백 기능이 탑재되어 있습니다. 분석 결과를 바탕으로 사용자는 프롬프트, RAG 데이터 소스 및 매개변수를 적절히 조정할 수 있습니다.
